...
removerAVL x (No y Vazia dir)   | x == y = dir
removerAVL x (No y esq Vazia)   | x == y = esq
removerAVL x (No y esq dir)     | x < y  = No y (rodarEsq (removerAVL x esq)) dir
                                | x > y  = No y esq (rodarDir (removerAVL x dir))
                                | x == y = let z = maisDir esq
                                        in No z (rodarEsq (removerAVL z esq)) dir
